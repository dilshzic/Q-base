...
import com.algorithmx.q_base.brain.models.AiGeneratedBlock
import com.algorithmx.q_base.brain.models.AiGeneratedTab
import com.algorithmx.q_base.brain.models.BlockType
import com.algorithmx.q_base.brain.models.NoteContext
...
class CommonAiService @Inject constructor(
    ...
    suspend fun generateNoteStructure(
        ...
        return aiBrainManager.askBrain(com.algorithmx.q_base.brain.models.BrainTask.NOTE_STRUCTURE, prompt).mapCatching { rawResponse ->
    ...
    suspend fun generateBlocksForTopic(
        ...
        return aiBrainManager.askBrain(com.algorithmx.q_base.brain.models.BrainTask.NOTE_BLOCKS, prompt).mapCatching { rawResponse ->
